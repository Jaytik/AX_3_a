<?php
// source: C:\wampe\www\AX_3\app/config/config.neon 
// source: C:\wampe\www\AX_3\app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'app\\components\\members\\memberscontrolfactory' => array(
				'22_App_Components_Members_MembersControlFactory',
			),
			'app\\components\\signin\\signincontrolfactory' => array(
				'23_App_Components_SignIn_SignInControlFactory',
			),
			'app\\components\\vypis\\vypiscontrolfactory' => array(
				'24_App_Components_Vypis_VypisControlFactory',
			),
			'nette\\security\\iauthenticator' => array('25_App_Model_UserManager'),
			'app\\model\\usermanager' => array('25_App_Model_UserManager'),
			'app\\model\\userrepository' => array('26_App_Model_UserRepository'),
			'app\\model\\users' => array('27_App_Model_Users'),
			'app\\routerfactory' => array('28_App_RouterFactory'),
			'app\\components\\filtrplat\\filtrplatcontrolfactory' => array('29'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\\wampe\\www\\AX_3\\app',
			'wwwDir' => 'C:\\wampe\\www\\AX_3\\www',
			'debugMode' => TRUE,
			...
			'tempDir' => 'C:\\wampe\\www\\AX_3\\app/../temp',
		));
	}


	/**
	 * @return App\Components\Members\MembersControlFactory
	 */
	public function createService__22_App_Components_Members_MembersControlFactory()
	{
		return new SystemContainer_App_Components_Members_MembersControlFactoryImpl_22_App_Components_Members_MembersControlFactory($this);
	}


	/**
	 * @return App\Components\SignIn\SignInControlFactory
	 */
	public function createService__23_App_Components_SignIn_SignInControlFactory()
	{
		return new SystemContainer_App_Components_SignIn_SignInControlFactoryImpl_23_App_Components_SignIn_SignInControlFactory($this);
	}
	 ...
	 */
	public function createService__24_App_Components_Vypis_VypisControlFactory()
	{
		return new SystemContainer_App_Components_Vypis_VypisControlFactoryImpl_24_App_Components_Vypis_VypisControlFactory($this);
	}
	 ...
	 */
	public function createService__26_App_Model_UserRepository()
	{
		$service = new App\Model\UserRepository($this->getService('database.default.context'));
		return $service;
	}
	 ...
	 */
	public function createService__27_App_Model_Users()
	{
		$service = new App\Model\Users;
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\\wampe\\www\\AX_3\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\\wampe\\www\\AX_3\\app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('C:\\wampe\\www\\AX_3\\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('C:\\wampe\\www\\AX_3\\app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('C:\\wampe\\www\\AX_3\\app/../temp/cache', $this->getService('nette.cacheJournal'));
	 ...
	 */
	public function createService__29()
	{
		return new SystemContainer_App_Components_FiltrPlat_FiltrPlatControlFactoryImpl_29($this);
	}
...
final class SystemContainer_App_Components_Members_MembersControlFactoryImpl_22_App_Components_Members_MembersControlFactory implements App\Components\Members\MembersControlFactory
{
	...
	{
		$service = new App\Components\Members\MembersControl($this->container->getService('26_App_Model_UserRepository'), $this->container->getService('database.default.context'));
		return $service;
	}
...
final class SystemContainer_App_Components_SignIn_SignInControlFactoryImpl_23_App_Components_SignIn_SignInControlFactory implements App\Components\SignIn\SignInControlFactory
{
	...
	public function create()
	{
		$service = new App\Components\SignIn\SignInControl($this->container->getService('user'));
		return $service;
	}
...
final class SystemContainer_App_Components_Vypis_VypisControlFactoryImpl_24_App_Components_Vypis_VypisControlFactory implements App\Components\Vypis\VypisControlFactory
{
	...
	public function create()
	{
		$service = new App\Components\Vypis\VypisControl($this->container->getService('26_App_Model_UserRepository'));
		return $service;
	}
...
final class SystemContainer_App_Components_FiltrPlat_FiltrPlatControlFactoryImpl_29 implements App\Components\FiltrPlat\FiltrPlatControlFactory
{
